...
'
echo " " 
echo -e "$red                        ▶Coded by$grn JATIN$red◀$rset"
echo -e "$red                      ⫸$ylo YOURHACKINGHOUSE$red ⫷$rset"
echo 
# Functions
...
echo -e "$red                        ➡$cyan [\e[92m3\e[96m] Access key"
echo -e "$red                        ➡$cyan [\e[92m4\e[96m] About"
echo -e "$red                        ➡$cyan [\e[92m5\e[96m] Reclone script "
echo -e "$red                        ➡$cyan [\e[92m6\e[96m] Subscribe"
echo -e "$red                        ➡$cyan [\e[92m7\e[96m] More"
...
then
am start -a android.intent.action.VIEW -d https://github.com/jatinkalwar > /dev/null 2>&1
banner
menu
elif [ $optnz = "8" ];
then
...
echo -e "\e[93m            HOPE YOU LIKE THIS HANGER" | pv -qL 10
...
while git clone https://github.com/jatinkalwar/hanger 2> /dev/null; do 
    printf  "\e[92m▓▓▓▓▓▓▓▓▓▓▓▓▓\e[0m"
    sleep 1
done
printf "\e[96m]\e[0m"
...
mv hang.txt $HOME/hanger/deal
cd $HOME/toolupdater/hangu
mv update.txt $HOME/hanger/deal
cd $HOME
rm -rf toolupdater
ake
}
